...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::get('/audit-detail/perlengkapan/rekap-gabungan', [PemeriksaanPerlengkapanController::class, 'rekapGabungan']);
    ...
    // ── TTP Gantung ──
    Route::get('/audit-detail/ttp-gantung',  [TtpGantungController::class, 'show']);
    Route::post('/audit-detail/ttp-gantung', [TtpGantungController::class, 'save'])
        ->middleware('akta.role:admin,manajer,auditor');
    Route::post('/audit-detail/ttp-gantung/parse-html', [TtpGantungController::class, 'parseHtml'])
        ->middleware('akta.role:admin,manajer,auditor');

    // ── Piutang CDN ──
    Route::get('/audit-detail/piutang-cdn',  [PiutangCdnController::class, 'show']);
    ...
    Route::get('/plan-audit-mandiri-crosscheck', [PlanAuditMandiriCrosscheckController::class, 'show']);
    Route::post('/plan-audit-mandiri-crosscheck', [PlanAuditMandiriCrosscheckController::class, 'store']);
