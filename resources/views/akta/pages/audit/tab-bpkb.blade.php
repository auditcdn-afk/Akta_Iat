        <div id="tabPanel-bpkb" class="audit-tab-panel hidden space-y-5">
            ...
            <div class="overflow-hidden rounded-2xl border border-slate-800 bg-slate-900 text-slate-100 shadow">
                <div class="flex items-center justify-between bg-[#1e3a5f] px-5 py-3 text-white">
                    ...
                    <p id="blankoBpkbStatus" class="hidden text-xs text-emerald-300">Tersimpan</p>
                </div>
                <div class="space-y-5 p-5">
                    <div>
                        ...
                        <table class="w-full text-sm">
                            <tbody id="blankoBpkbH1Body"></tbody>
                        </table>
                        </div>
                        <button type="button" data-add="blankoBpkbH1" class="add-row-btn mt-2 rounded-lg border border-dashed border-slate-600 px-3 py-1.5 text-xs font-semibold text-slate-300 hover:bg-slate-800">+ Tambah Register Blanko H1</button>
                    </div>
                    <div>
                        <div class="mb-2 border-b border-slate-800 pb-1 text-sm font-bold text-slate-300">H2</div>
                        <div class="overflow-x-auto">
                        <table class="w-full text-sm">
                            <tbody id="blankoBpkbH2Body"></tbody>
                        </table>
                        </div>
                        <button type="button" data-add="blankoBpkbH2" class="add-row-btn mt-2 rounded-lg border border-dashed border-slate-600 px-3 py-1.5 text-xs font-semibold text-slate-300 hover:bg-slate-800">+ Tambah Register Blanko H2</button>
                    </div>
                    <div class="flex justify-end border-t border-slate-800 pt-4">
                        <button type="button" id="blankoBpkbSaveBtn" class="rounded-xl bg-blue-600 px-6 py-2.5 text-sm font-semibold text-white hover:bg-blue-500 transition">💾 Simpan Register Blanko</button>
                    </div>
                </div>
            </div>
