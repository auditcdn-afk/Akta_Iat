        <div id="tabPanel-hga" class="audit-tab-panel hidden space-y-5">
            ...
            <div class="rounded-2xl border border-blue-700/40 bg-blue-900/10 p-4">
                ...
                <div class="space-y-3">
                    ...
                    <div id="hgaFormFields" class="hidden space-y-3">
                        <div class="flex flex-col gap-1">
                            <label class="text-xs font-semibold text-slate-300">Qty (Fisik Scan) <span class="text-red-400">*</span></label>
                            <div class="flex items-center gap-2">
                                <button id="hgaFormQtyDec" type="button" class="rounded-lg bg-slate-700 px-3 py-1.5 text-slate-200 hover:bg-slate-600">−</button>
                                <input type="number" id="hgaFormQty" value="0"
                                ...
                                <button id="hgaFormQtyInc" type="button" class="rounded-lg bg-slate-700 px-3 py-1.5 text-slate-200 hover:bg-slate-600">+</button>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <div id="hgaFormLog" class="rounded-lg border border-slate-700 bg-slate-800/60 px-3 py-2 text-xs text-slate-400">
                    ...
                    {{-- Peringatan kalau ada hasil scan yang belum sampai ke server;
                         diisi oleh hgaSetSyncWarn() di audit-editor.js. --}}
                    <p id="hgaSyncWarn" class="hidden mt-1 rounded-lg border border-amber-600/50 bg-amber-900/20 px-3 py-2 text-xs font-semibold text-amber-300"></p>
                </div>
            </div>
